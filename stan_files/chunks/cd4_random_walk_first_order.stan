  ...
  //Coding up the simple four bin cd4 count model with an R variable that can alter through time and is then modelling using a first order penalized spline
  ...
  dydt[1] =  params[t / 1] - y[1] ;                                                                                                      // This is our kappa parameter changing through time 
